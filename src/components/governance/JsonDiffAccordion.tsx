...
// Adapted from apps/sv/frontend/src/components/governance/JsonDiffAccordion.tsx
...
function JsonToggleButton({ expanded, onClick }: JsonToggleButtonProps) {
  return (
    <Box
      component="button"
      type="button"
...
export interface JsonDiffAccordionProps {
  ...
  readonly variant?: 'form' | 'review';
}

export function JsonDiffAccordion({ children, variant = 'review' }: JsonDiffAccordionProps) {
